...
interface MapInterface extends \Traversable, \Countable
{
     ...
     * @return MapInterface
     */
    function filterNot(callable $p): MapInterface;
     ...
     * @return MapInterface
     */
    function flatMap(callable $f): MapInterface;
     ...
     * @return \Traversable
     */
    function grouped(int $size): \Traversable;
     ...
     * hash map.
     *
     * @param \Traversable $that
     *
     * @return bool
     */
    function sameElements(\Traversable $that): bool;
     ...
     * @return \Traversable
     */
    function sliding(int $size, int $step = 0): \Traversable;
...
//function toStream(): \streamWrapper;
     ...
     * @return MapInterface
     */
    function zip(\Traversable $that): MapInterface;
     ...
     * @return MapInterface
     */
    function zipAll(\Traversable $that, $thisElem, $thatElem): MapInterface;
